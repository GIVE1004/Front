            ...
            <View style={{alignItems:'center'}}>
              {/* 기부자 */}
                <View><Caption color={Color.Black_80}>기부자(월 단위 증감)</Caption></View>
                  <Caption color={Color.Danger_50}>{props.groupNumber} 명 {props.groupNumberPm}</Caption>
            </View>
            <View style={{alignItems:'center'}}>
              {/* 관심지수 */}
                <View><Caption color={Color.Black_80}>관심지수</Caption></View>
                  <Caption color={Color.Success_50}>{props.groupStar} 점 {props.gruopStarPm}</Caption>
            </View>
        </View>
      </View>
    );
