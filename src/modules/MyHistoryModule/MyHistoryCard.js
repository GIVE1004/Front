    ...
    <ScrollView>
      ...
      <View style={{ marginHorizontal: 20, padding: 10, backgroundColor: Color.Black_20, borderRadius: 10, paddingBottom: 30 }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
          ...
          <Body fontWeight={'bold'} fontSize={16} color={Color.Secondary_50}>
            {AddComma(data.groupDonationTotal)} 원
          </Body>
        </View>
        <Spacer space={16}></Spacer>
        <Divider />
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
          ...
          <Body fontWeight={'bold'} fontSize={16} color={Color.Secondary_50}>
            {AddComma(data.goalBudgetTotal)} 원
          </Body>
        </View>
        <Spacer space={16}></Spacer>
      </View>
...
export const HistoryCard = ({ data, color }) => {
  const [isVisible, setIsVisible] = useState(false);
  const navigation = useNavigation();
  ...
  return (
    ...
    >
      ...
      <MyModal height='60%' isVisible={isVisible} setIsVisible={setIsVisible}>
        <History data={data} />
        <Footer>
          <BasicButton width='50%' backgroundColor={Color.Danger_50} borderColor={Color.Danger_50}>
            <Heading fontSize={16} color={Color.White_100}>
  ...
  return (
    <ScrollView>
      ...
      <View style={{ marginHorizontal: 20, padding: 10, backgroundColor: Color.Black_20, borderRadius: 10, paddingBottom: 30 }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
          <Body fontSize={14}>기부종료일</Body>
          <Body fontSize={14}>{data.donationEnddate}</Body>
        </View>
        <Spacer space={16} />
        <Divider />
        <Spacer space={16} />
